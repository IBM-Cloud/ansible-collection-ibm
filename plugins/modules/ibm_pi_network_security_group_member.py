...
DOCUMENTATION = '''
---
module: ibm_pi_network_security_group_member
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/pi_network_security_group_member

short_description: Configure IBM Cloud 'ibm_pi_network_security_group_member' resource
...
options:
    ...
    pi_network_security_group_id:
        ...
        required: True
        type: str
    pi_network_security_group_member_id:
        description:
...
TL_CONFLICTS_MAP = {
    'pi_network_security_group_member_id': ['pi_target', 'pi_type'],
    'pi_type': ['pi_network_security_group_member_id'],
    'pi_target': ['pi_network_security_group_member_id'],
}
...
module_args = dict(
    ...
    pi_network_security_group_id=dict(
        required=False,
        type='str'),
    pi_network_security_group_member_id=dict(
        required=False,
        type='str'),
    pi_type=dict(
        required=False,
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_pi_network_security_group_member',
        tf_type='resource',
