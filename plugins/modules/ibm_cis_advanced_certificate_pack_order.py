...
DOCUMENTATION = '''
---
module: ibm_cis_advanced_certificate_pack_order
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/cis_advanced_certificate_pack_order

short_description: Configure IBM Cloud 'ibm_cis_advanced_certificate_pack_order' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_cis_advanced_certificate_pack_order',
        tf_type='resource',
