...
DOCUMENTATION = '''
---
module: ibm_dns_linked_zone
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/dns_linked_zone

short_description: Configure IBM Cloud 'ibm_dns_linked_zone' resource
...
module_args = dict(
    ...
    label=dict(
        required=False,
        type='str'),
    approval_required_before=dict(
        required=False,
        type='str'),
    instance_id=dict(
        required=False,
        type='str'),
    owner_instance_id=dict(
        required=False,
        type='str'),
    id=dict(
        required=False,
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_dns_linked_zone',
        tf_type='resource',
