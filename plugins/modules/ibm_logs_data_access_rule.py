...
DOCUMENTATION = '''
---
module: ibm_logs_data_access_rule
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/logs_data_access_rule

short_description: Configure IBM Cloud 'ibm_logs_data_access_rule' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_logs_data_access_rule',
        tf_type='resource',
