...
DOCUMENTATION = '''
---
module: ibm_kms_kmip_objects_info
for_more_info: refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/data-sources/kms_kmip_objects

short_description: Retrieve IBM Cloud 'ibm_kms_kmip_objects' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_kms_kmip_objects',
        tf_type='data',
