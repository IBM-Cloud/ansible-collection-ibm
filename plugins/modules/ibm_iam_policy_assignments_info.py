...
DOCUMENTATION = '''
---
module: ibm_iam_policy_assignments_info
for_more_info: refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/data-sources/iam_policy_assignments

short_description: Retrieve IBM Cloud 'ibm_iam_policy_assignments' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_iam_policy_assignments',
        tf_type='data',
