...
DOCUMENTATION = '''
---
module: ibm_onboarding_catalog_plan
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/onboarding_catalog_plan

short_description: Configure IBM Cloud 'ibm_onboarding_catalog_plan' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_onboarding_catalog_plan',
        tf_type='resource',
