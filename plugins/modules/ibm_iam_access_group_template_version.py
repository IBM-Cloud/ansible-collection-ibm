...
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/iam_access_group_template_version

short_description: Configure IBM Cloud 'ibm_iam_access_group_template_version' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_iam_access_group_template_version',
        tf_type='resource',
