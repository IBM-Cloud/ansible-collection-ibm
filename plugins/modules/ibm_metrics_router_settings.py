...
DOCUMENTATION = '''
---
module: ibm_metrics_router_settings
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/metrics_router_settings

short_description: Configure IBM Cloud 'ibm_metrics_router_settings' resource
