...
DOCUMENTATION = '''
---
module: ibm_sm_en_registration
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/sm_en_registration

short_description: Configure IBM Cloud 'ibm_sm_en_registration' resource
...
module_args = dict(
    ...
    event_notifications_source_name=dict(
        required=False,
        type='str'),
    event_notifications_source_description=dict(
        required=False,
        type='str'),
    instance_id=dict(
        required=False,
