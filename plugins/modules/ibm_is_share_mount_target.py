...
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/is_share_mount_target

short_description: Configure IBM Cloud 'ibm_is_share_mount_target' resource
...
TL_CONFLICTS_MAP = {
    'virtual_network_interface': ['vpc'],
    'vpc': ['virtual_network_interface'],
}
