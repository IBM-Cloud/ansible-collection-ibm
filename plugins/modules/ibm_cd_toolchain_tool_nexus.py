...
DOCUMENTATION = '''
---
module: ibm_cd_toolchain_tool_nexus
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/cd_toolchain_tool_nexus

short_description: Configure IBM Cloud 'ibm_cd_toolchain_tool_nexus' resource

version_added: "2.8"

description:
    - Create, update or destroy an IBM Cloud 'ibm_cd_toolchain_tool_nexus' resource
...
def run_module():
    ...
    result_ds = ibmcloud_terraform(
        resource_type='ibm_cd_toolchain_tool_nexus',
        tf_type='data',
