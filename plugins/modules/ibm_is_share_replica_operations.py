...
DOCUMENTATION = '''
---
module: ibm_is_share_replica_operations
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/is_share_replica_operations

short_description: Configure IBM Cloud 'ibm_is_share_replica_operations' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_is_share_replica_operations',
        tf_type='resource',
