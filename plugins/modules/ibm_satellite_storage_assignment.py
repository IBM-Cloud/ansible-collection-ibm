...
DOCUMENTATION = '''
---
module: ibm_satellite_storage_assignment
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/satellite_storage_assignment

short_description: Configure IBM Cloud 'ibm_satellite_storage_assignment' resource
...
def run_module():
    ...
    result_ds = ibmcloud_terraform(
        resource_type='ibm_satellite_storage_assignment',
        tf_type='data',
