...
DOCUMENTATION = '''
---
module: ibm_is_reservations_info
for_more_info: refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/data-sources/is_reservations

short_description: Retrieve IBM Cloud 'ibm_is_reservations' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_is_reservations',
        tf_type='data',
