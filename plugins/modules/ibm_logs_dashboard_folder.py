...
DOCUMENTATION = '''
---
module: ibm_logs_dashboard_folder
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/logs_dashboard_folder

short_description: Configure IBM Cloud 'ibm_logs_dashboard_folder' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_logs_dashboard_folder',
        tf_type='resource',
