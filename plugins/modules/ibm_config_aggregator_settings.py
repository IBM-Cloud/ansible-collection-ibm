...
DOCUMENTATION = '''
---
module: ibm_config_aggregator_settings
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/config_aggregator_settings

short_description: Configure IBM Cloud 'ibm_config_aggregator_settings' resource
...
TL_REQUIRED_PARAMETERS = [
    ('resource_collection_regions', 'list'),
    ('instance_id', 'str'),
...
module_args = dict(
    resource_collection_regions=dict(
        required=False,
        elements='',
        type='list'),
    additional_scope=dict(
        required=False,
        elements='',
        type='list'),
    instance_id=dict(
    ...
    region=dict(
        required=False,
        type='str'),
    resource_collection_enabled=dict(
        required=False,
        type='bool'),
    trusted_profile_id=dict(
        required=False,
        type='str'),
    id=dict(
        required=False,
...
def run_module():
    ...
    result_ds = ibmcloud_terraform(
        resource_type='ibm_config_aggregator_settings',
        tf_type='data',
