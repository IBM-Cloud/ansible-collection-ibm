...
DOCUMENTATION = '''
---
module: ibm_scc_template_attachment
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/scc_template_attachment

short_description: Configure IBM Cloud 'ibm_scc_template_attachment' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_scc_template_attachment',
        tf_type='resource',
