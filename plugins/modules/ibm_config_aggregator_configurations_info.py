...
DOCUMENTATION = '''
---
module: ibm_config_aggregator_configurations_info
for_more_info: refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/data-sources/config_aggregator_configurations

short_description: Retrieve IBM Cloud 'ibm_config_aggregator_configurations' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_config_aggregator_configurations',
        tf_type='data',
