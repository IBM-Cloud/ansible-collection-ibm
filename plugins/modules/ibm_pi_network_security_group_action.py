...
DOCUMENTATION = '''
---
module: ibm_pi_network_security_group_action
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/pi_network_security_group_action

short_description: Configure IBM Cloud 'ibm_pi_network_security_group_action' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_pi_network_security_group_action',
        tf_type='resource',
