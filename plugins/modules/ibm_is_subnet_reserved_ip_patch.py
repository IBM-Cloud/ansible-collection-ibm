...
DOCUMENTATION = '''
---
module: ibm_is_subnet_reserved_ip_patch
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/is_subnet_reserved_ip_patch

short_description: Configure IBM Cloud 'ibm_is_subnet_reserved_ip_patch' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_is_subnet_reserved_ip_patch',
        tf_type='resource',
