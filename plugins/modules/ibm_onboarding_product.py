...
DOCUMENTATION = '''
---
module: ibm_onboarding_product
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/onboarding_product

short_description: Configure IBM Cloud 'ibm_onboarding_product' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_onboarding_product',
        tf_type='resource',
