...
DOCUMENTATION = '''
---
module: ibm_onboarding_registration
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/onboarding_registration

short_description: Configure IBM Cloud 'ibm_onboarding_registration' resource
...
module_args = dict(
    ...
    primary_contact=dict(
        ...
        elements='',
        type='list'),
    default_private_catalog_id=dict(
        required=False,
        type='str'),
    provider_access_group=dict(
        required=False,
        type='str'),
    id=dict(
        required=False,
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_onboarding_registration',
        tf_type='resource',
