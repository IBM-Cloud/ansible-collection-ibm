...
DOCUMENTATION = '''
---
module: ibm_scc_template
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/scc_template

short_description: Configure IBM Cloud 'ibm_scc_template' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_scc_template',
        tf_type='resource',
