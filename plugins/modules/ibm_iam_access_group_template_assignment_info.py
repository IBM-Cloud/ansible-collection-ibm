...
for_more_info: refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/data-sources/iam_access_group_template_assignment

short_description: Retrieve IBM Cloud 'ibm_iam_access_group_template_assignment' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_iam_access_group_template_assignment',
        tf_type='data',
