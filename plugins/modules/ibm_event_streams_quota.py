...
DOCUMENTATION = '''
---
module: ibm_event_streams_quota
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/event_streams_quota

short_description: Configure IBM Cloud 'ibm_event_streams_quota' resource
...
module_args = dict(
    ...
    entity=dict(
        required=False,
        type='str'),
    producer_byte_rate=dict(
        required=False,
        type='int'),
    consumer_byte_rate=dict(
        required=False,
        type='int'),
    id=dict(
        required=False,
...
def run_module():
    ...
    result_ds = ibmcloud_terraform(
        resource_type='ibm_event_streams_quota',
        tf_type='data',
