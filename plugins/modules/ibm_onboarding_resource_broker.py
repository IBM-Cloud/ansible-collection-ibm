...
DOCUMENTATION = '''
---
module: ibm_onboarding_resource_broker
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/onboarding_resource_broker

short_description: Configure IBM Cloud 'ibm_onboarding_resource_broker' resource
...
module_args = dict(
    ...
    auth_scheme=dict(
        required=False,
        type='str'),
    resource_group_crn=dict(
        required=False,
        type='str'),
    allow_context_updates=dict(
        required=False,
        type='bool'),
    catalog_type=dict(
        required=False,
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_onboarding_resource_broker',
        tf_type='resource',
