...
DOCUMENTATION = '''
---
module: ibm_pi_spp_placement_group_info
for_more_info: refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/data-sources/pi_spp_placement_group

short_description: Retrieve IBM Cloud 'ibm_pi_spp_placement_group' resource
...
module_args = dict(
    pi_cloud_instance_id=dict(
        required=True,
        type='str'),
    pi_spp_placement_group_id=dict(
        required=True,
        type='str'),
    zone=dict(
        type='str',
